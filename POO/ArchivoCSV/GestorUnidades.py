# SI tengo Datos en un archivosCSV
...
# Leer el archivo CSV y, por cada fila, crear una instancia de esa clase.
    def leer_Unidades(self):
        self.lista_Unidades=[]
        with open('POO/ArchivoCSV/unidades.csv', mode='r', newline='', encoding='utf-8') as archivo:
    ...
    def guardar_Unidades(self):
        with open('POO/ArchivoCSV/unidadesMOD.csv', mode='w', newline='',encoding='utf-8') as archivo:
...
nueva=Unidad(116,"SSSS","SERVICIO SISTEMA SYS SIN",12)
gestor.agregar_unidad(nueva)

nueva=Unidad(117,"SSS1","SERVICIO SISTEMA SYS UNO",12)
gestor.agregar_unidad(nueva)

nueva=Unidad(118,"SSS2","SERVICIO SISTEMA SYS DOS",12)
gestor.agregar_unidad(nueva)
